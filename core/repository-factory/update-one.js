 ...
 * @property {Object} options - Mongoose Options
 */
 ...
 */
function updateOneFactory(modelOrName) {
  ...
  return async function (_data) {
    try {
      ...
      const updateResult = await Model.updateOne(data.query, data.updateValues, data.options);
